              ...
              return (
                <tr
                  ...
                  <td className="py-4 px-6 space-x-2">
                    <Link to={`/skills/${skill.id}/edit`} className="px-4 py-2 bg-green-500 hover:bg-indigo-700 text-white rounded-md">
                      Edit
                   </Link>
                   <button onClick={() => deleteSkill (skill.id)} className="px-4 py-2 bg-red-500 hover:bg-indigo-700 text-white rounded-md">Delete</button>
                  </td>
                </tr>
              );
            })}
